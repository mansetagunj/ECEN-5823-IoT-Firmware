...
#ifndef __BTMESH_CONFIG__
#define __BTMESH_CONFIG__
...
// Use this macro to check if bt_mesh_stack plugin is included
#define SILABS_AF_PLUGIN_BT_MESH_STACK
...
// Use this macro to check if Serial VCOM plugin is included
#define SILABS_AF_PLUGIN_SERIAL_VCOM
